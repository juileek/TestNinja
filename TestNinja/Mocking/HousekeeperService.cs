...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        private readonly IEmailSenderBase _emailSenderBase;
        ...
        public HousekeeperService(IUnitOfWork unitOfWork, IStatementGenerator statementGenerator,
            IEmailSenderBase emailSenderBase, IXtraMessageBox xtraMessageBox)
        {
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                try
                {
                    _emailSenderBase.EmailFile(emailAddress, emailBody, statementFilename,
